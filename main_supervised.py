...
from model.args.supervised import parse_cfg
from model.methods.supervised import SupervisedModel
from model.data.dataset import ISICDataset, LightlyDataset
...
def main(cfg: DictConfig):
    ...
    if cfg.auto_resume.enabled and cfg.resume_from_checkpoint is None:
        auto_resumer = AutoResumer(
            checkpoint_dir=os.path.join(cfg.checkpoint.dir, "supervised"),
    ...
    if cfg.checkpoint.enabled:
        ...
        ckpt = Checkpointer(
            cfg,
            logdir=os.path.join(cfg.checkpoint.dir, "supervised"),
