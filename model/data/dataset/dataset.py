...
from model.data.dataset.utils import DatasetFolder
...
class LightlyDataset:
    ...
    def __init__(self,
        ...
        if self.input_dir is not None:
            self.dataset = load_dataset_from_folder(
                root=self.input_dir,
                transform=transform,
        ...
        self.index_to_filename = index_to_filename or _get_filename_by_index
    ...
    def __getitem__(self, index: int):
        """Returns (index, sample, target) of item at index.
